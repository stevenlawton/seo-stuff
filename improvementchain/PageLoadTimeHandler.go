...
func (h *PageLoadTimeHandler) Handle(page *models.AnalysisData, improvements *[]models.Improvement) {
	if page.PageLoadTimeSeconds > 3.0 {
		*improvements = append(*improvements, models.Improvement{
			Name:     "Page Load Time Too High",
			Field:    "PageLoadTimeSeconds",
			OldValue: "Page load time: " + fmt.Sprintf("%.2f", page.PageLoadTimeSeconds) + " seconds",
